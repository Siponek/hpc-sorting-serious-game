...
@onready var theme_option_button = $MarginContainer/VBoxContainer/ThemeSection/ThemeOptionButton
@onready var theme_preview = $MarginContainer/VBoxContainer/ThemeSection/ThemePreview
@onready var save_button = $MarginContainer/VBoxContainer/ButtonSection/SaveButton
@onready var close_button = $MarginContainer/VBoxContainer/ButtonSection/CloseButton
