...
class Scripts:
	...
	const GD_SYNC_WEB_PATCH = "res://scenes/Multiplayer/GDSyncWebPatch.gd"
	const LOCAL_SERVER_SIGNALING = "res://scenes/Multiplayer/LocalServerSignaling.gd"
	...
	const SIGNALING_CLIENT = "res://scenes/Multiplayer/SignalingClient.gd"
