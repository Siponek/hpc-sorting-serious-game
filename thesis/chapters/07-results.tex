...
\begin{itemize}
    ...
    \item Distributed card ownership (MPI simulation)
    \item Selective card visibility (private buffers hidden)
...
\begin{table}[htbp]
    ...
    \begin{tabular}{@{}lll@{}}
        ...
        \midrule
        Shared Memory (OpenMP)      & Main card container          & Implemented       \\
        Thread-Local Storage        & Private buffer zones         & Implemented       \\
        Distributed Memory (MPI)    & Per-player card sets         & Implemented       \\
        Message Passing             & Card exchanges               & Implemented       \\
        Communication Overhead      & Network latency              & Implicit          \\
...
\begin{itemize}
    ...
    \item \textbf{Conceptual Connection}: Participants with HPC background (8/8) recognized OpenMP and MPI analogies
...
\begin{table}[htbp]
    ...
    \begin{tabular}{@{}llc@{}}
        ...
        \midrule
        Educational                   & OpenMP simulation                & \checkmark Met    \\
                                      & MPI simulation                   & \checkmark Met    \\
