...
\begin{figure}[htbp]
	\centering
	\includegraphics[width=0.85\textwidth]{figures/diagrams/physical-to-digital-mapping.pdf}
...
\begin{figure}[htbp]
	\centering
	\includegraphics[width=0.9\textwidth]{figures/diagrams/sequential-vs-openmp-modes.pdf}
...
\textbf{Chapter~\ref{ch:background}} reviews parallel computing fundamentals (focusing on OpenMP shared-memory parallelism), serious games in education, mobile game development challenges, and multiplayer architecture patterns, identifying gaps in existing HPC educational tools.
